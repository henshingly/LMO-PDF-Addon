...
?>
              ...
              <button type="button" class="custom-btn btn-pdf1" data-toggle="modal" data-target="#pdfModal_Matchday"><span><?php echo $text['pdf'][0]?></button>
              <!-- PDF Modal -->
              <div class="modal fade" id="pdfModal_Matchday" tabindex="-1" role="dialog" aria-labelledby="pdfModalTitle" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="pdfModalTitle"><?php echo $text['pdf'][108]?></h5>
...
?>
              <!-- Trigger the modal with a button -->
              <button type="button" class="custom-btn btn-pdf1" data-toggle="modal" data-target="#pdfModal_Schedule"><span><?php echo $text['pdf'][0]?></button>
              <!-- PDF Modal -->
              <div class="modal fade" id="pdfModal_Schedule" tabindex="-1" role="dialog" aria-labelledby="pdfModalTitle" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="pdfModalTitle"><?php echo $text['pdf'][107]?></h5>
                      <button type="button" class="custom-btn btn-pdf1" data-dismiss="modal"><?php echo $text['pdf'][290]?></button>
                    </div>
                    <div class="modal-body">
