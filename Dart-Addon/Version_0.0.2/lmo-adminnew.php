...
$xligaType=isset($_POST['xligaType'])?$_POST['xligaType']:""; // Dart Liga
...
if($newpage<3){ ?>
  ...
  if($newpage>0){ ?>
        ...
        <input type="hidden" name="xligaType" value="<?= $xligaType; ?>"><?
  }
  if($newpage>1){ ?>
...
if($newpage==0){ ?>
   ...
   <!-- Dart Patch -->
          <tr>
            <td width="20">&nbsp;</td>
            <td class="nobr" align="right"><acronym title="<?= $text[4023] ?>"><?= $text[4024]; ?></acronym></td>
            <td class="nobr" align="left"><acronym title="<?= $text[4023] ?>">
