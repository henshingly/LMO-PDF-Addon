...
/** Liga Manager Online 4
  ...
  *
  * $Id: lmo-showtable.php,v 1.24 2005/08/21 10:03:28 jokerlmo Exp $
  */
if ($minus == 2) {
...
if ($ligaType == "dart" ) $gesamtbreite += 2; // Dart Patch
?>
...
if ( $ligaType == "dart") : ?>
    <th width="2">&nbsp;</th>
    <th width="2" colspan="3"><?=$text[4020]?></th>
    <th width="2">&nbsp;</th>
...
for($x = 1; $x <= $anzteams; $x++) {
  $stripTeam = $ligaType=="dart"?50:34; 
  $i = intval( substr($tab0[$x-1], $stripTeam));
  if ($i == $favteam) {
    $dummy = "<strong>";
    $dumm2 = "</strong>";
  } else {
...
// DartLiga  
  if ( $ligaType == "dart") : ?>
    <td class="<?=$lmo_tabelle_class?>" width="2">&nbsp;</td>
    <td class="<?=$lmo_tabelle_class?>" ><?=$dummy.$psaetze[$i].$dumm2; ?></td>
    <td class="<?=$lmo_tabelle_class; ?>" align="center" width="4"><?=$dummy; ?>:<?=$dumm2; ?></td>  
    <td class="<?=$lmo_tabelle_class?>" ><?=$dummy.$msaetze[$i].$dumm2; ?></td>  
    <td class="<?=$lmo_tabelle_class?>" width="2">&nbsp;</td>
    <td class="<?=$lmo_tabelle_class?>" align="right"><?=$dummy.$dsaetze[$i].$dumm2; ?></td>
<? endif;   
// DartLiga    
  if($tabpkt==1){?>
    <td class="<?=$lmo_tabelle_class?>" width="2">&nbsp;</td>
