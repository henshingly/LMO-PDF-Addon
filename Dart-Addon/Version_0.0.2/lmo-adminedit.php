...
// Dart Liga  
  if ($ligaType == "dart") : 
    $DartLigaBreite = 4;     
  ?>
     <th colspan="<?=$DartLigaBreite;?>"> <?=$text[4020]?></td>
...
// Dart Liga  
  ...
  for($i = 0; $i < $anzsp; $i++) {
   ...
   <!-- Dart Liga  //-->      
     <? if ($ligaType == "dart" ) : ?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?=$text[4021] ?>" class="lmo-formular-input" type="text" name="xsatza<?=$i; ?>" size="1" maxlength="4" value="<?=$satza[$st-1][$i]; ?>" tabindex="<?=$i;?>9" onChange="lmotorgte('b','<?=$i; ?>')" onKeyDown="lmotorclk('b','<?=$i; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?=$text[4022] ?>" class="lmo-formular-input" type="text" name="xsatzb<?=$i; ?>" size="1" maxlength="4" value="<?=$satzb[$st-1][$i]; ?>" tabindex="<?=$i;?>9" onChange="lmotorgte('b','<?=$i; ?>')" onKeyDown="lmotorclk('b','<?=$i; ?>',event.keyCode)"></td>
     <? endif; 
   // Dart Liga   
      if($spez==1){?>
            <td width="2">&nbsp;</td>
  ...
  <!-- Dart Liga  //-->      
     <? if ($ligaType == "dart" ) : ?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?=$text[4021] ?>" class="lmo-formular-input" type="text" name="xsatza<?=$i.$n; ?>" size="1" maxlength="4" tabindex="<?=$i.$n;?>7" value="<?=$satza[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?=$i.$n; ?>')" onKeyDown="lmotorclk('b','<?=$i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?=$text[4022] ?>" class="lmo-formular-input" type="text" name="xsatzb<?=$i.$n; ?>" size="1" maxlength="4" tabindex="<?=$i.$n;?>8" value="<?=$satzb[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?=$i.$n; ?>')" onKeyDown="lmotorclk('b','<?=$i.$n; ?>',event.keyCode)"></td>
     <? endif; ?>
  <!-- Dart Liga  //-->            
