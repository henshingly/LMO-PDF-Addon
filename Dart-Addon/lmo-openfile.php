  ...
  if(substr($file,-4)==".l98"){
    ...
    if ($datei) {
        ...
        if((substr($zeile,0,1)=="[") && (substr($zeile,-1)=="]")){
          ...
          if($sekt=="Options"){
            switch ($schl) {
              ...
              case "LigaType":     $ligaType=stripslashes($wert);break;  // Dart Patch
      ...
      if($lmtype==0){
        ...
        $satza = array_pad($array,116,"");      // Dart Patch
        $satzb = array_pad($array,116,"");      // Dart Patch
        ...
        $satza = array_pad($array,7,"");      // Dart Patch
        $satzb = array_pad($array,7,"");      // Dart Patch
        ...
        for($i=0;$i<7;$i++){
          ...
          for($j=0;$j<64;$j++){
            ...
            $satza[$i][$j] = array_pad(array("0"),7,"0");      // Dart Patch
            $satzb[$i][$j] = array_pad(array("0"),7,"0");      // Dart Patch
          ...
          if($lmtype==0) {
            switch ($op8) {
              ...
              case "SA":
                 ...
                 elseif($satza[$op3][$op4]=="-1"){$satza[$op3][$op4]="0";}
              break;
              case "SB":
                 $satzb[$op3][$op4]=$dum[2];
