...
<table class="lmoMiddle" cellspacing="0" cellpadding="0" border="0">
    ...
    <td align="center">
      <form name="lmoedit" action="<?=$_SERVER['PHP_SELF']; ?>" method="post" onSubmit="return chklmopass()">
        ...
        <table class="lmoInner" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <th class="nobr" align="left" colspan="<?=$breite-12; ?>"><?
  echo $st.". ".$text[2];
  if ($datum1[$st-1] != "") {
    $datum = explode('.', $datum1[$st-1]);
  ...
  if ($goalfaktor!=1) {?>
            <th class="nobr" colspan="<?=$breite-11; ?>"><?if ($goalfaktor!=1) {echo "(".$text[553+log10($goalfaktor)].")";}?></th><?
  } else {?>
            <th colspan="<?=$breite-11; ?>"><?=$text[38]?></th><?
  }
// Dart Liga Hack Anfang
  if ($ligaType == "dart") :
    $DartLigaBreite = 4;
  ?>
     <th colspan="<?=$DartLigaBreite;?>"> <?=$text['dart'][000]?></td>
  ...
  for($i = 0; $i < $anzsp; $i++) {
   ...
   // Dart Liga Hack Ende
      if($spez==1){?>
            <td width="2">&nbsp;</td>
            <td>
              <select class="lmo-formular-input" name="xmspez<?=$i; ?>" onChange="dolmoedit()" tabindex="<?=$i;?>11" >
            ...
            <td width="2">&nbsp;</td>
            <td align="center">
              <select id="gT<?=$i?>" class="lmo-formular-input" name="xmsieg<?=$i; ?>" onChange="dolmoedit()" tabindex="<?=$i;?>12" >
      ...
      if($msieg[$st-1][$i]==0) {?>
            ...
            <td align="center">
              <input id="n<?=$i?>" class="lmo-formular-input" type="text" name="xmnote<?=$i; ?>" tabindex="<?=$i;?>13" size="16" maxlength="255" value="<?=htmlentities($mnote[$st-1][$i]); ?>" onChange="dolmoedit()"><?
      ...
      if($_SESSION['lmouserok']==2 && $ftest0==1){ ?>
            <td>
              <select class="lmo-formular-input" name="xmtipp<?=$i; ?>" onChange="dolmoedit()" tabindex="<?=$i;?>14" >
